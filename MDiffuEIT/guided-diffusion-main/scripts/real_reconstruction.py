...
This code is used to reconstruct the real measured voltage data, 
and the data is saved in txt format. vh is the reference voltage and vi is the measured voltage
...
def main():
    ...
    with open(args.vh_path, "r", encoding='utf-8') as f1:  
        vh_txt = f1.readline()   
    with open(args.realy_data_path, "r", encoding='utf-8') as f:  
        vi_txt = f.readline()   
    vh = vh_txt.split(',')
    vi = vi_txt.split(',')
    vh =  np.array(vh)
...
def create_argparser():
    defaults = dict(
        ...
        pre_model_path="/home/guided-diffusion-main/dilation_model.pt",
        vh_path = "/home/guided-diffusion-main/data/vh.txt",
        realy_data_path = "/home/guided-diffusion-main/data/vi.txt",
        flag_c = 1,
        num = 666,  
    )
